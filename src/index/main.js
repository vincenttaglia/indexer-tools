...
const store = new Vuex.Store({
  state: {
    ...
    indexerAccounts: Vue.$cookies.get("indexerAccounts") ? Vue.$cookies.get("indexerAccounts") : [{name: "Acct 1", address: Vue.$cookies.get("indexer") ? Vue.$cookies.get("indexer") : "0xeddd4ec5d3775de964416b7b9d4da885f530f90a" }],
